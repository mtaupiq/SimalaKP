...
<div class="container">
    <div class="row">
    	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    		<form class="form-horizontal" role="form" method="POST" action="{{ route('mahasiswa.update', $mhs->id) }}">
    			{{ csrf_field() }}
                <input type="hidden" name="_method" value="PUT">
		        <div class="panel panel-primary">
		        	<div class="panel-heading">
	                    <h3 class="panel-title">Ubah Data Mahasiswa {{$mhs->nama}}</h3>
	                </div>
		            <div class="panel-body">
	                    <div class="form-group{{ $errors->has('npm') ? ' has-error' : '' }}">
	                        ...
	                        <div class="col-md-6">
	                            <input id="npm" type="text" class="form-control" name="npm" value="{{ $mhs->npm }}" required autofocus>
		            ...
		            <div class="panel-footer">
		            	<div class="row">
	                        <div class="col-md-6 col-md-offset-4">
	                            ...
	                            <a class="btn btn-default" href="{{route('mahasiswa.index')}}" role="button">Batal</a>
	                        </div>
		            	</div>
		            </div>
		        </div>
