	            						...
	            						<tbody>
	            							...
	            							<tr>
	            								...
	            								<td class="text-center" style="vertical-align: middle;">
	            									<a class="btn btn-xs btn-primary" href="{{route('laporandp.show', $l->id)}}" role="button"><span class="glyphicon glyphicon-zoom-in" aria-hidden="true"></span></a>
	            								</td>
	            							</tr>
	            							@endforeach
	            						</tbody>
