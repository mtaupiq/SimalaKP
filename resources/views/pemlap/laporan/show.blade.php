    	...
    	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	        ...
	        <div class="panel panel-primary">
	            	...
	            	<table class="table table-hover table-responsive" style="margin-bottom: 0px;">
	            		<tbody>
	            			...
	            			<tr>
	            				...
	            				<th>:</th>
	            				<td>
	            					@if($laporan->verified_by_pl == 0)
	            					<form action="{{route('laporanpl.update', $laporan->id)}}" method="POST" role="form">
	            						{{csrf_field()}}
	            ...
	            <div class="panel-footer">
	            	<a class="btn btn-default" href="{{route('laporanpl.index')}}" role="button">Kembali</a>
	            </div>
	        </div>
    	</div>
    </div>
